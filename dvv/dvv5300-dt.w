...
*******************************************************************************/
{include/i-prgvrs.i dvv5300-dt 2.00.00.000}
...
DEF INPUT-OUTPUT PARAMETER p-dt-contab AS DATE NO-UNDO.
DEF INPUT-OUTPUT PARAMETER p-dt-estorno AS DATE NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS rt-buttom dt-contab dt-estorno bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS dt-contab dt-estorno 
...
DEFINE VARIABLE dt-contab AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Provis∆o" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE dt-estorno AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Estorno" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.
...
DEFINE FRAME D-Dialog
     dt-contab AT ROW 1.33 COL 21 COLON-ALIGNED WIDGET-ID 2
     dt-estorno AT ROW 2.29 COL 21 COLON-ALIGNED WIDGET-ID 4
     bt-ok AT ROW 4 COL 3
     bt-cancela AT ROW 4 COL 14
     bt-ajuda AT ROW 4 COL 40.57
     rt-buttom AT ROW 3.75 COL 2
...
DO:
  ASSIGN p-dt-contab  = INPUT FRAME {&frame-name} dt-contab
         p-dt-estorno = INPUT FRAME {&frame-name} dt-estorno.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY dt-contab dt-estorno 
      WITH FRAME D-Dialog.
  ENABLE rt-buttom dt-contab dt-estorno bt-ok bt-cancela bt-ajuda 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "dvv5300-dt" "2.00.00.000"}
